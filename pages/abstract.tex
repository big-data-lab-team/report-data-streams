...
% \acrshort{iot}, especially \acrfull{wsn}. 
The rise of embedded systems and wireless technologies led to the emergence of
the \acrshort{iot}. In \acrshort{iot}, connected objects communicate with each
...
gives a higher compression ratio than the polynomial regression method and
\TG{for a lower memory and CPU consumption}.
\end{abstract}
