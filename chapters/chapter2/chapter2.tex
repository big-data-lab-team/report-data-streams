...
counting Algorithm needs $O(\log\log N)$ space complexity, where N is the number
of hash-values (the number of distinct elements in stream). 
...
\todo{ writing paragraph}
sliding window 放下面，写几个  带silding window 算 cardinality 的例子
