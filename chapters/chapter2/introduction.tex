...
% all items in  the stream have the same probability to be selected. The common idea is
...
% this user.
% \TG{This paragraph is too long, I don't think we need to read details about
% random sampling since you're not going to use it later.}
...
small amount of reconstructed accuracy \TG{Why? See paper intro. You could reuse some of that text here},
 we prefer lossy compression method which
might gives higher compression ratio \TG{Sentence is too long, please split}. 
