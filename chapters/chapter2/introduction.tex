...
the stream through $d$ hash functions $h_{i}(e)_{i\in \llbracket 1, d \rrbracket}
\rightarrow \{1, 2, ..., w\}$ and $d$ extra 4-wise independent hash functions
$g_1$, ..., $g_d$ : $\{1...m\}\rightarrow \{-1, 1\}$. Finally, The second
