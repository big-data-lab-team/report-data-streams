...
Figure~\ref{fig:poly-regression-5-degree} shows the reconstructed data \TG{Why do you show this for PR and not for LTC?
If you still want to show it, you should at least put the figures on the same y scale as figure 6}. In the
...
bytes for recording time-stamp) \TG{This paragraph is out of place. I think it can be removed, your
discussion in the paragraphs below is enough.}.

From Table~\ref{table:CR-compare-walking} and
Table~\ref{table:CR-compare-running}, we observe that LTC n-dimension gives better compression ratio
