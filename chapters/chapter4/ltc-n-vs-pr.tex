...
between two transmissions and long processing time, $O(d^2 n)$ for
$d$-dimensional data stream, to calculate coefficients and build model when each
new data point comes. Because we implemented polynomial regression method and
LTC n-dimension in different platforms, the comparison of memory usage and
processing time between them cannot be measured.
