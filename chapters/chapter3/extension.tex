...
\todo{reconstructed LTC related work~\ref{sec:ltc}}
...
Using these notations and details in Section~\ref{sec:ltc}, the original LTC
...
The LTC algorithm generalized to dimension $n$ tests that the LTC  property in
...
for instance 3D  accelerometers or 3D gyroscopes, and the multiple
unidimensional  version is more suitable for multiple independent sensors, for
