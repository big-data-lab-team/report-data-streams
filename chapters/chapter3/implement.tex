...
B)} (
see Algorithm~\ref{algo:find_bisection_function}) and \texttt{recursive(S, L, R, N, $X^n$)} (see Algorithm~\ref{algo:recursive}) show how it works. \TG{\#\#This paragraph has overlap with the previous one, writing should be revised
...
\TG{Also, add a reference to plane sweep.}
